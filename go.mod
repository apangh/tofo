module github.com/apangh/tofo

go 1.15

require (
	github.com/apangh/salt v0.0.0-20210411223200-a64e5c269ace
	github.com/apangh/tofo/logger v0.0.0-20210404214106-abc797e2b951
